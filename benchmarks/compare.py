...
def plot_results(custom, reedsolo, urs, bch, galois_bch):
    ...
    ax1.bar(x - width, custom, width, label='Ours Reed Solomon', color='skyblue')
    ...
    fig1.savefig(IMAGES_DIR / 'benchmark_results.png')

    # Graph 2: Custom vs BCH
    width2 = 0.25
    fig2, ax2 = plt.subplots(figsize=(10, 6))
    ax2.bar(x - width2, custom, width2, label='Ours Reed Solomon', color='skyblue')
    ...
    fig2.tight_layout()
    fig2.savefig(IMAGES_DIR / 'bch_comparison.png')

    print("\nResults saved to images/benchmark_results.png and images/bch_comparison.png")
